     ...
     <div class="row"> 
         ...
         <div class="col-md-12">
             ...
             <div class="card">
                ...
                <form method="post" action="{{route('department.store')}}"  enctype="multipart/form-data" id="edit-form">
                             ...
                             <div class="col-md-12">
                                <label class="col-sm-2 label-on-left">Description</label>
                                 <div class="col-sm-10">
                                     <div class="form-group label-floating is-empty">
                                         <label class="control-label"></label>
                                         <textarea name="description" class="form-control" rows="4" cols="130" required=""></textarea>
