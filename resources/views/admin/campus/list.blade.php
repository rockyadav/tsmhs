                ...
                <div class="card-content">
                    ...
                    <div class="material-datatables">
                        <div class="add-more text-right">
                           <a class="btn btn-rose btn-fill" href="{{route('campus.create')}}" style="margin: -66px 15px 0;">Add<div class="ripple-container"></div></a>
                        </div>
                        ...
                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                              ...
                              @endphp
                                ...
                                <td>{{$row->name}}</td>
                                <td class="td-actions">
                                   <a href="{{url('admin/campus/edit/'.$row->id)}}"><button type="button" rel="tooltip" class="btn btn-success">
...
function deleteMyData(id)
{
    ...
    buttonsStyling: false
        ...
        $.ajax({
                ...
                url: base_url+'/admin/campus-destroy/'+id,
                method:"get",
