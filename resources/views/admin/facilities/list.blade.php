                ...
                <div class="card-content">
                    <h4 class="card-title">Facilities</h4>
                     <div class="add-more text-right">
                            <a class="btn btn-rose btn-fill" href="{{route('facilities.create')}}" style="margin: -66px 15px 0;">Add<div class="ripple-container"></div></a>
                        </div>
                    <div class="toolbar">
                            ...
                            <tbody>
                              ...
                              @endphp
                                ...
                                <td class="td-actions">
                                        ...
                                        <a href="{{url('admin/facilities/edit/'.$row->id)}}"><button type="button" rel="tooltip" class="btn btn-success">
...
function deleteMyData(id)
{
    ...
    buttonsStyling: false
        ...
        $.ajax({
                url: base_url+'/admin/facilities-destroy/'+id,
                method:"get",
