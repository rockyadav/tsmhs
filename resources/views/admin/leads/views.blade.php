         ...
         <div class="col-md-12">
             ...
             <div class="card">
                    ...
                    <div class="back-btn text-right">
                        ...
                        <a class="btn btn-rose btn-fill" href="{{ url('admin/leads')}}">Back<div class="ripple-container"></div></a>

                    </div>

                    <form method="post" action="{{url('admin/lead-update')}}" enctype="multipart/form-data" id="myForm">
                     {{ csrf_field() }}
