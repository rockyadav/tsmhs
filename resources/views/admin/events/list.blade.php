                ...
                <div class="card-content">
                    ...
                    <div class="material-datatables">
                        <div class="add-more text-right">
                            <a class="btn btn-rose btn-fill" href="{{route('events.create')}}" style="margin: -66px 15px 0;">Add<div class="ripple-container"></div></a>
                        </div>
                        ...
                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                              @if(count($data['list'])>0)
                                ...
                                <td class="td-actions">
                                        <a href="{{url('admin/events/show/'.$row->id)}}"><button type="button" rel="tooltip" class="btn btn-warning">
                                            <i class="material-icons">visibility</i>
                                        </button></a>
                                        <a href="{{url('admin/events/edit/'.$row->id)}}"><button type="button" rel="tooltip" class="btn btn-success">
...
function deleteMyData(id)
{
    ...
    buttonsStyling: false
        ...
        $.ajax({
                url: base_url+'/admin/events-destroy/'+id,
                method:"get",
