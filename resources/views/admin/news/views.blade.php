            ...
            <div class="col-md-12">
                <div class="card">
                 ...
                 <h4 class="card-title">News Details</h4>
                    ...
                    <a href="{{url('admin/news')}}"> <button type="button" class="btn btn-rose" style="margin: -80px 15px 0;">Back<div class="ripple-container"></div></button></a>
                    </div>
                            ...
                            <div class="tab-pane active" id="pill1">
                                <div class="row">
                                     <div class="col-md-12">
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <img src="{{ url('public/images/news/'.$data['detail']->image) }}" class="rimg" />
                                                @else 
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <label class="col-md-4 label-on-right">News Date</label>
                                        <div class="col-md-8">
                                            <div class="form-group label-floating is-empty">
                                               {{date('d-m-Y',strtotime($data['detail']->news_date))}}
                                                <span class="material-input"></span>
                                            </div>
                                        </div>
                                    </div>
