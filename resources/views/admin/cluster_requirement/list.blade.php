...
@section('page-title','Cluster requirement')
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <h4 class="card-title">Cluster Requirements</h4>
                    ...
                    <div class="material-datatables">
                        ...
                        <div class="add-more text-right">
                            ...
                            <a class="btn btn-rose btn-fill" href="{{route('cluster-requirement.create')}}" style="margin: -66px 15px 0;">Add<div class="ripple-container"></div></a>
                        ...
                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td class="td-actions">
                                        ...
                                        <a href="{{url('admin/cluster-requirement/edit/'.$row->id)}}"><button type="button" rel="tooltip" class="btn btn-success">
...
function deleteMyData(id)
{
    ...
    buttonsStyling: false
        ...
        $.ajax({
                ...
                url: base_url+'/admin/cluster-requirement-destroy/'+id,
