...
@section('page-title', 'Edit Download File')
@section('content')
     ...
     <div class="row"> 
         <div class="col-md-12">
             <div class="card">
                    ...
                    <form method="post" action="{{url('admin/downloads-update')}}" class="save-form" enctype="multipart/form-data" id="edit-form">
                     {{ csrf_field() }}
                     <div class="card-content">
                        ...
                        <button class="btn btn-rose btn-fill" id="submit" type="submit">Update</button>
                         </div>
                     </div>
                </form>
             </div>
